...
import com.miaosha.model.TextMessageModel;
import com.miaosha.service.WeixinCoreService;
import com.miaosha.util.WeixinMessageInfo;
import com.miaosha.util.WeixinMessageUtil;
...
public class WeixinCoreServiceImpl implements WeixinCoreService {
    private static final Logger logger = LogManager.getLogger(WeixinCoreServiceImpl.class);
    @Autowired
